    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
          I am a Full-Stack Developer with a passion for delivering exceptional results and a dedication to teaching.
          </p>
          <p>
          With my expertise in React and Next.js on the frontend, and Java with Spring Boot on the backend, I bring a unique combination of technical skills and a commitment to educating others. My focus is not only on developing top-notch software solutions but also on imparting valuable knowledge, ensuring that every project I work on benefits from both my development expertise and my enthusiasm for teaching.
          </p>
        </div>
